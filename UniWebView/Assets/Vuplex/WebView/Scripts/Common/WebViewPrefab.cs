...
namespace Vuplex.WebView {
    ...
    /// <summary>
    /// WebViewPrefab is a prefab that makes it easy to view and interact with an IWebView in world space.
    ...
    /// <list type="number">
    ///   <item>
    ///     By dragging the WebViewPrefab.prefab file into your scene via the editor and then setting its "Initial URL" property.
    ///   </item>
    ///   <item>
    ...
    ///   <item>How clicking works: https://support.vuplex.com/articles/clicking</item>
    ...
    public class WebViewPrefab : BaseWebViewPrefab {
        ...
        /// <summary>
        /// Determines the scroll sensitivity. The default is 0.005.
        /// </summary>
        [HideInInspector]
