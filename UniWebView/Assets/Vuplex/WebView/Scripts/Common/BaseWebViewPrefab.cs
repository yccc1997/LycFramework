...
namespace Vuplex.WebView {
    ...
    public abstract class BaseWebViewPrefab : MonoBehaviour {
        ...
        /// Important notes:
        /// <list type="bullet">
        ///   <item>This setting is ignored when running in [Native 2D Mode](https://support.vuplex.com/articles/native-2d-mode).</item>
        ///   <item>
        ...
        [Tooltip("Determines how the prefab handles drag interactions. Note that this setting is ignored when running in Native 2D Mode.")]
        ...
        /// </summary>
        /// <remarks>
        /// This setting is ignored when running in [Native 2D Mode](https://support.vuplex.com/articles/native-2d-mode).
        /// </remarks>
        public bool ClickingEnabled = true;

        /// <summary>
        /// Determines whether hover intactions are enabled.
        /// </summary>
        /// <remarks>
        /// Important notes:
        /// <list type="bullet">
        ...
        void _initWebViewIfReady(IWebView webView, Rect rect, bool enableNative2DMode = false) {
            ...
            if (initializedWebViewWasProvided) {
                ...
                if (webView is IWithNative2DMode && enableNative2DMode) {
                    ...
                    (webView as IWithNative2DMode).InitInNative2DMode(rect);
                    _view.Visible = false;
                } else {
